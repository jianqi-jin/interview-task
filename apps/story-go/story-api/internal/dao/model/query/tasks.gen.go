...
func newTask(db *gorm.DB, opts ...gen.DOOption) task {
	...
	_task.OriImgKey = field.NewString(tableName, "ori_img_key")
	_task.LatestImgKey = field.NewString(tableName, "latest_img_key")
...
type task struct {
	...
	ALL          field.Asterisk
	ID           field.Int64
	Name         field.String // task名称
	Description  field.String // task描述
	OriImgKey    field.String // original image
	LatestImgKey field.String // masked matest image
...
func (t *task) updateTableName(table string) *task {
	...
	t.OriImgKey = field.NewString(table, "ori_img_key")
	t.LatestImgKey = field.NewString(table, "latest_img_key")
...
func (t *task) fillFieldMap() {
	...
	t.fieldMap["ori_img_key"] = t.OriImgKey
	t.fieldMap["latest_img_key"] = t.LatestImgKey
