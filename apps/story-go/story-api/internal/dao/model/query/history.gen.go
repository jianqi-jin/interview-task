...
func newHistory(db *gorm.DB, opts ...gen.DOOption) history {
	...
	_history.TaskID = field.NewInt64(tableName, "task_id")
	_history.Data = field.NewString(tableName, "data")
	_history.Version = field.NewInt32(tableName, "version")
	_history.IsActive = field.NewInt32(tableName, "is_active")
	_history.CreateTime = field.NewTime(tableName, "create_time")
	_history.UpdateTime = field.NewTime(tableName, "update_time")
	_history.Status = field.NewInt32(tableName, "status")
...
type history struct {
	...
	Data       field.String // json详细信息
	Version    field.Int32  // history 相对于mask的 version
	IsActive   field.Int32  // 是否是当前版本 1 当前版本 0 历史版本
	CreateTime field.Time
	UpdateTime field.Time
	Status     field.Int32 // 1=待审核, 2=审核通过, 3=审核失败
...
func (h *history) updateTableName(table string) *history {
	...
	h.TaskID = field.NewInt64(table, "task_id")
	h.Data = field.NewString(table, "data")
	h.Version = field.NewInt32(table, "version")
	h.IsActive = field.NewInt32(table, "is_active")
...
func (h *history) fillFieldMap() {
	...
	h.fieldMap["id"] = h.ID
	h.fieldMap["task_id"] = h.TaskID
	h.fieldMap["data"] = h.Data
	h.fieldMap["version"] = h.Version
	h.fieldMap["is_active"] = h.IsActive
